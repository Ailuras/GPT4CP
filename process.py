...
for file in filenames:
    ...
    with open(path, 'r') as load_f:
        ...
        if type == 'mzn':
            ...
            prompt = "The "+load_dict['name']+" problem is: "+load_dict['prompt']+" Model the "+load_dict['name']+" problem using the Python API of CP-SAT solver of OR-Tools. Please only output the code in the format of code block, without any prompt or explanation."
        else:
